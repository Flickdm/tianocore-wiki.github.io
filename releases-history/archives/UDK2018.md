...
UDK2018 is a [UDK](UDK.md) release based on a validated snapshot of [EDK II](EDK-II.md). The previous stable branch was [UDK2017](UDK2017.md).
...
* [PcAtChipsetPkg Notes](PcAtChipsetPkg.md)
