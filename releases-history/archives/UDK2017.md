...
UDK2017 is a [UDK](UDK.md) release based on a validated snapshot of [EDK II](../../reference/external-resources/EDK-II.md). The previous stable branch was [UDK2015](UDK2015.md).
...
[https://github.com/tianocore/edk2/releases/tag/vUDK2017](https://github.com/tianocore/edk2/releases/tag/vUDK2017) <br>
_NOTE: this wiki page contains more details on the changes for this release._

## How to Build UDK2017

Please see: [UDK2017 How to Build](../../archives/build-tooling/build-workflows/UDK2017-How-to-Build.md) wiki page for details on how to build for Windows* and Linux like Development systems.

## UDK2017 Branch/Tag

There is a tag (**vUDK2017**) for the UDK2017 release in github:
[https://github.com/tianocore/edk2/tree/vUDK2017](https://github.com/tianocore/edk2/tree/vUDK2017).  This tag can be used to download the official release of UDK2017 source code by using the `git clone` command with the tag. <br>
...
* Please See [UDK2017 Core Update Notes](UDK2017-Core-Update-Notes.md) for changes to the UEFI EDK II core package changes.
* Known Issues:
...
_Note:_ these files can also be downloaded from the [UDK2017 Release Page](https://github.com/tianocore/edk2/releases/tag/vUDK2017) at: [https://github.com/tianocore/edk2/releases/tag/vUDK2017](https://github.com/tianocore/edk2/releases/tag/vUDK2017) <br>
...
_Note:_ this file can also be downloaded from the [UDK2017 Release Page](https://github.com/tianocore/edk2/releases/tag/vUDK2017) at: [https://github.com/tianocore/edk2/releases/tag/vUDK2017](https://github.com/tianocore/edk2/releases/tag/vUDK2017) <br>
