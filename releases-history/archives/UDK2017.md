...
[https://github.com/tianocore/edk2/tree/vUDK2017](https://github.com/tianocore/edk2/tree/vUDK2017).  This tag can be used to download the official release of UDK2017 source code by using the `git clone` command with the tag.   
...
_Note:_ these files can also be downloaded from the [UDK2017 Release Page](https://github.com/tianocore/edk2/releases/tag/vUDK2017) at: [https://github.com/tianocore/edk2/releases/tag/vUDK2017](https://github.com/tianocore/edk2/releases/tag/vUDK2017)   
...
_Note:_ this file can also be downloaded from the [UDK2017 Release Page](https://github.com/tianocore/edk2/releases/tag/vUDK2017) at: [https://github.com/tianocore/edk2/releases/tag/vUDK2017](https://github.com/tianocore/edk2/releases/tag/vUDK2017)   
