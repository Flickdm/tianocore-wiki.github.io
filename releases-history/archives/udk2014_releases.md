...
See [UDK](udk.md) for current UEFI
Development Kit releases

If you have questions please email the
[edk2-devel](mailto:edk2-devel@lists.01.org)
email list.
...
<th width="20%" style="background-color:#fdbb13">

Download

</th>

<th width="55%" style="background-color:#fdbb13">

What

</th>

<th width="25%" style="background-color:#fdbb13">
...
UEFI development Kit 2014 SP1 Specification Release \#1 (UDK2014.SP1.P1)
...
**Supported OS and Build Environments**
  ...
  Linux](using_edk_ii_with_native_gcc.md)
...
updates (version 1.24) that are available with the UDK2014.SP1.P1
...
This download contains all .chm and .html documents for UDK2014. Each
package includes details on the definitions (including
PPIs/PROTOCOLs/GUIDs and library classes) and libraries instances
associated with each package. Optionally, Download all the CHMs
converted to PDF Format in the second .zip

</td>

<td>

Contains both .chm file and .html files in this .zip for all UDK2014
documents
...
The [EdkCompatibilityPkgdocuments](../../archives/platforms-packages/edk_compatibility_pkg.md) provide
...
UEFI development Kit 2014 SP1 Specification Release \#1 (UDK2014.SP1)
(Complete zip of all packages and documentation where packages are
expanded to MyWorkSpace Directory)
...
**How to Build**
[UDK2014-How-to-Build](../../archives/build-tooling/build-workflows/udk2014_how_to_build.md) UDK2014 Release
...
[EDK-II-Specifications](../../reference/specs-standards/edk_ii_specifications.md) EDK II v1.22
Errata D and V1.24 specifications

These documents describe the EDK II build information for the following
(Build, DEC, DSC, FDF and INF) file formats and it contains the Errata
updates (version 1.22 Errata D and 1.24) that are available with the
UDK2014.SP1 release. See details in the Revision History in each of the
individual documents for more details.

- Update January, 2014 V 1.22 Errata D
- Update Aug, 2014 V 1.24
...
UEFI development Kit 2014 Specification Release \#1 (udk2014.md) (Complete
zip of all packages and documentation where packages are expanded to
MyWorkSpace Directory)
...
These documents describe the EDK II build information for the following
(Build, DEC, DSC, FDF and INF) file formats and it contains the Errata
updates (version 1.22 Errata D) that are available with the UDK2014
release. (Except DEC did not change from Errata C) See details in the
Revision History in each of the individual documents for more details.
