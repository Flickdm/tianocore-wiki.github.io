...
* [edk-apps](edk-apps.md) EDK applications
...
* [efi-sct](efi-sct.md)  UEFI SCT has been moved to the UEFI Forum at [http://www.uefi.org](http://www.uefi.org) members page.

# Older, unmaintained projects

* [EFI Toolkit](EFI-Toolkit.md) is a set of tools that support rapid porting and development of EFI applications, and promote a uniform pre-boot environment on 32 and 64 bit based platforms.
