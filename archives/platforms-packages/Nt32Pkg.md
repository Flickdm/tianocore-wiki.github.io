...
Nt32Pkg has been removed. Please use the [EmulatorPkg](../../platforms-packages/platform-ports/EmulatorPkg.md) as an
alternative.
...
The goals and features of the Nt32Pkg platform are similar to [UnixPkg](UnixPkg.md) and
[EmulatorPkg](../../platforms-packages/platform-ports/EmulatorPkg.md). Our long term goal is to port
[EmulatorPkg](../../platforms-packages/platform-ports/EmulatorPkg.md) to Microsoft Windows and retire Nt32Pkg.

Using NT32 emulation with Windows:

* To build Nt32pkg in Windows see: How to build using [Windows
  Systems](../../build-tooling/environment-setup/Windows-systems.md)
