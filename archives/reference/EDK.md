...
Contains UEFI 2.1, Framework 0.9, PI 1.0 and
...
`Mobile Framework Dev Patch 4`</a>``
...
`Mobile Framework Dev Patch 3`</a>``
...
Client Framework Patches are an update to
...
`Edk-Dev Shapshot-20100527.zip`</a>``
...
`Development Snapshot Diff Patches`</a>``

</td>

<td>

To see the differences between snapshot
...
`Intel Undi UEFI Source 4606.zip`</a>``
...
`Intel Undi UEFI Rel 15 7 Src.zip`</a>``
