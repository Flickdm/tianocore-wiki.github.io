...
If you would like to make code contributions to our community, please refer to our [Code
Contributions](../../development/contribution-guides/Code-Contributions.md) and [[Member Types]] pages.

## Licenses for TianoCore Contributions

The preferred license for TianoCore is [[BSD+Patent|BSD Plus Patent License]]. When that is not possible, then
contributions using
...
Example:
[https://github.com/tianocore/edk2/blob/master/License.txt](https://github.com/tianocore/edk2/blob/master/License.txt)

Source file headers should contain an [SPDX](https://spdx.org/licenses/) identifier of the license. An example is
provided on the [[BSD+Patent|BSD Plus Patent License]] page.
