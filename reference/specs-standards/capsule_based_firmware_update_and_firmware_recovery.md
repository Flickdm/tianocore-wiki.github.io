...
* [Using a Signed Capsule to Perform a Device Firmware Update](reference/specs-standards/capsule_based_device_firmware_update.md)
* [Using a Capsule to perform a CPU Microcode Update](Capsule-Based-CPU-Microcode-Update)
* [Using a Signed Capsule as a System Firmware Recovery Image](reference/specs-standards/capsule_based_system_recovery_image.md)
