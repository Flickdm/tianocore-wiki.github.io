...
into the master branch of the [[Intel® Galileo Gen 2|Galileo]] and [[MinnowBoard Max|MinnowBoardMax]] platform firmware
...
> NOTE: These instructions only cover how to generate a new X.509 Certificate Chain using OpenSSL. It is up to the
