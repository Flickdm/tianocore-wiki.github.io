...
UDK2017 is a [UDK](UDK.md) release based on a validated snapshot of [EDK II](EDK-II.md). The previous stable branch was [UDK2015](UDK2015.md).
...
* Miscellaneous
  1. EDK II documentation is available from the [EDK-II-Documents](EDK-II-Documents.md)
...
* [BaseTools Notes](BaseTools.md)
* [CryptoPkg Notes](https://github.com/tianocore-docs/Docs/blob/master/UDK/UDK2017/CryptoPkgNotes.md)
* [IntelFrameworkModulePkg Notes](IntelFrameworkModulePkg.md)
* [IntelFrameworkPkg Notes](IntelFrameworkPkg.md)
...
* [MdeModulePkg Notes](MdeModulePkg.md)
* [MdePkg Notes](MdePkg.md)
* [NetworkPkg Notes](NetworkPkg.md)
* [PerformancePkg Notes](PerformancePkg.md)
...
* [SourceLevelDebugPkg Notes](SourceLevelDebugPkg.md)
...
see [EDK II Specifications](EDK-II-Specifications.md) for the latest revision and descriptions of each specification
