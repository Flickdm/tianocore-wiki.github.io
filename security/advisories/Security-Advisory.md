...
Obsolete Please use : [Reporting Security Issues](../processes/Reporting-Security-Issues.md)
----
...
If you wish to describe a security issue regarding the code on tianocore.org, please use the “**Report**” button below.
Please include the paths of the modules you believe are involved and a detailed description of the issue. The mail is
...
To request to join the list, use the REPORT button with “**JOIN**” as the first word in the mail subject title. To
remove yourself from the list, use the REPORT button with “**LEAVE**” as the first word in the mail subject title.
