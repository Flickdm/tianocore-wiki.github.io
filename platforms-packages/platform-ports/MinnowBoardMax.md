...
The project is based on Intel® Atom™ processors. Technical details, schematics, and information on expansion boards (Lures) can be found at [http://minnowboard.org](http://minnowboard.org)

A list of currently supported boards and prices can be found at: [https://minnowboard.org](https://minnowboard.org) under the "[Boards](https://minnowboard.org/compare-boards)" tab

### UEFI Firmware - Release

Documentation, binary images, and source build instructions are at [https://software.intel.com/en-us/articles/minnowboard-maxturbot-uefi-firmware](https://software.intel.com/en-us/articles/minnowboard-maxturbot-uefi-firmware)
