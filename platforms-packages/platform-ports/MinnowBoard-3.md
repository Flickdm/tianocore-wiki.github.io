...
MinnowBoard 3 was a follow-on to the [[MinnowBoard Max|MinnowBoardMax]] & MinnowBoard Turbot platforms. This design will
be migrated to [[MinnowBoard 3 Module]] (release date TBD).
