...
OVMF is an [EDK II](../../reference/external-resources/EDK-II.md) based project to enable
...
More information: [OVMF FAQ](../../reference/faqs-glossaries/OVMF-FAQ.md), [How to build
OVMF](../../development/tutorials-howto/How-to-build-OVMF.md), [[Boot Overview|OVMF-Boot Overview]], [[edk2-devel]]
