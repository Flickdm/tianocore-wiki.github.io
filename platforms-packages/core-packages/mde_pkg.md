...
[UDK](../../releases-history/archives/udk.md) releases.
...
based on the [EDK II](../../reference/external-resources/edk_ii.md)
...
latest .chm files see [UDK](../../releases-history/archives/udk.md)
