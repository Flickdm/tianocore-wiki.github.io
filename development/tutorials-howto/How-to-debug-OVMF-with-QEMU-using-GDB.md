...
3. Copy the output of SampleApp to the `hda-contents` directory similarly as shown in [How-to-run-OVMF](How-to-run-OVMF.md) as a file system for QEMU.  This will be in a similar directory to the following : `/home/u-mypc/src/edk2/Build/OvmfIa32/DEBUG_GCC5/IA32`
...
4. Open a terminal(1) prompt in the `run-ovmf` directory as shown in [How-to-run-OVMF](How-to-run-OVMF.md) with the ovmf.fd file copied to bios.bin.
