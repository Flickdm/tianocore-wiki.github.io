...
[How-to-run-OVMF](How-to-run-OVMF.md) as a file system for QEMU. This will be in a similar directory to the following :
...
4. Open a terminal(1) prompt in the `run-ovmf` directory as shown in [How-to-run-OVMF](How-to-run-OVMF.md) with the
