...
The SMI handler profile feature was introduced to help a developer analyzes which SMI handlers are exposed in an given
boot.
...
The PCD - PcdSmiHandlerProfilePropertyMask defined in
...
to control the behaviors of SMI handler profile feature.
...
After SMI handler profile feature is enabled by configuring PCDs above, SmmChildDispatcher driver should call
SmiHandlerProfileRegisterHandler() to report SMI handler information. This API is defined in SmiHandlerProfileLib
library
class([https://github.com/tianocore/edk2/blob/master/MdePkg/Include/Library/SmiHandlerProfileLib.h](https://github.com/tianocore/edk2/blob/master/MdePkg/Include/Library/SmiHandlerProfileLib.h)).
...
After SMI handler profile feature is enabled and the system boots to SHELL,
SmiHandlerProfileInfo([https://github.com/tianocore/edk2/tree/master/MdeModulePkg/Application/SmiHandlerProfileInfo](https://github.com/tianocore/edk2/tree/master/MdeModulePkg/Application/SmiHandlerProfileInfo))
application in MdeModulePkg can be used to dump the information, then
SmiHandlerProfileSymbolGen.py([https://github.com/tianocore/edk2/blob/master/BaseTools/Scripts/SmiHandlerProfileSymbolGen.py](https://github.com/tianocore/edk2/blob/master/BaseTools/Scripts/SmiHandlerProfileSymbolGen.py))
can be used to convert RVA address to symbols and convert GUID name to a user readable string. In Linux,
SmiHandlerProfileSymbolGen.py will parse the debug information generated by the GCC compiler through “nm”. In Windows,
SmiHandlerProfileSymbolGen.py will parse the PDB information generated by the MSVC compiler through Microsoft Visual
Studio “DIA SDK”.
...
6. **Copy SmiHandlerProfileInfoTemp.txt to OS, run SmiHandlerProfileSymbolGen.py to convert RVA address to symbols and
GUID to human readable string.**

Note: In Windows, SmiHandlerProfileSymbolGen.py will parse the PDB information generated by the MSVC compiler through
