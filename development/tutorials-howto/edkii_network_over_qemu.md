...
Stack](../../platforms-packages/core-packages/networkpkg_getting_started_guide.md) via
[QEMU](https://wiki.qemu.org/), you should review information on how to run the
[OVMF](../../platforms-packages/platform-ports/ovmf.md) platform. OVMF can execute the EDK II network stack
...
Topology](../../Projects/NetworkPkg/Images/QEMU_OVMF_Network_Topology.png)
...
![QEMU OVMF Network
Scalability](../../Projects/NetworkPkg/Images/QEMU_OVMF_Network_Scalability.png)
...
![PCI Hierarchy](../../Projects/NetworkPkg/Images/PCI_Hierarchy.png "PCI
Hierarchy")
...
[../../platforms-packages/core-packages/networkpkg_getting_started_guide.md](../../platforms-packages/core-packages/networkpkg_getting_started_guide.md)
...
4. OVMF Introduction:
[../../platforms-packages/platform-ports/ovmf.md](../../platforms-packages/platform-ports/ovmf.md)
5. OvmfPkg README:
