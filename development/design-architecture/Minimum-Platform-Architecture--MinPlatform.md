...
- [Kaby Lake MinPlatform](../../platforms-packages/platform-ports/Kaby-Lake-MinPlatform.md) - EDK II platform firmware
...
- [[Project Olympus (Purley MinPlatform)|Purley MinPlatform]] - EDK II platform firmware for the Open Compute Project
  (OCP) [Intel XSP
...
- [Whiskey Lake MinPlatform](../../platforms-packages/platform-ports/Whiskey-Lake-MinPlatform.md) - EDK II platform
