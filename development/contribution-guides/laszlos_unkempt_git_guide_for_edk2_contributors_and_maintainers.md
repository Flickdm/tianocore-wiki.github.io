...
```admonish caution "Deprecated Process"
This document describes a deprecated process of contributing changes using
...
Development Process
article](edk_ii_development_process.md)
...
23. [&sect;](#contrib-23)
     ...
     [above](#contrib-10), the -O parameter can be left out.
...
project](edk_ii_development_process.md#the-maintainer-process-for-the-edk-ii-project)
